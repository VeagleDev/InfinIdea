...
function process_image(string $path, string $id)
{
    ...
    $hd_size = array(($width > $height ? array(1440, $height * 1440 / $width) : array($width * 1440 / $height, 1440)));
    $sd_size = array(($width > $height ? array(720, $height * 720 / $width) : array($width * 720 / $height, 720)));
    $thumb_size = array(($width > $height ? array(360, $height * 360 / $width) : array($width * 360 / $height, 360)));
