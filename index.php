...
<body>
    ...
    <?php logs('ouverture de la page accueil', 'utilisateur connecté se connecte sur la page d\'accueil', $_SESSION['id']); ?>
    ...
    <?php logs('ouverture de la page accueil', 'utilisateur déconnecté se connecte sur la page d\'accueil'); ?>
    <?php endif; ?>
